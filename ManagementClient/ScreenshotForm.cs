...
namespace ManagementClient
{
    public partial class ScreenshotForm : Form
    {
        ...
        private bool _remoteSessionStarted = false;
        ...
        private async void ScreenshotForm_Shown(object? sender, EventArgs e)
        {
            if (_remoteSessionStarted)
                return;
            ...
            try
            {
                ...
                {
                    await connection.InvokeAsync("StartRemoteControl", agentName);
                    _remoteSessionStarted = true;
                }
            }
            catch (Exception ex)
            {
                MessageBox.Show("Hiba a távoli vezérlés indításakor: " + ex.Message);
            }
        }
        ...
        protected override void OnFormClosing(FormClosingEventArgs e)
        {
            ...
            if (_remoteSessionStarted && connection?.State == HubConnectionState.Connected)
            {

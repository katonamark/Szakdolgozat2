...
namespace AgentUI
{
    public partial class ClientUI : Form
    {
        ...
        public ClientUI()
        {
            ...
            Shown += ClientUI_Shown;
            Resize += ClientUI_Resize;
        ...
        private void BuildConnection()
        {
            ...
            connection.On<string>("ReceiveCommand", async command =>
            {
                ...
                catch (Exception ex)
                {
                    ...
                    RunOnUi(() => AddLog($"Hiba parancsvégrehajtáskor: {ex.Message}"));
                }
        ...
        private void InitializeServerReconnectTimer()
        {
            ...
            _serverReconnectTimer.Interval = 5000;
        ...
        private async Task EnsureConnectedAsync()
        {
            ...
            try
            {
                ...
                {
                    RunOnUi(() => lblStatus.Text = "Kapcsolódás a szerverhez...");
        ...
        {
            if (rtbChatHistory.IsDisposed)
                return;

            if (rtbChatHistory.InvokeRequired)
            {
                rtbChatHistory.BeginInvoke(new Action(() => AppendChatLine(text)));
                return;
            }
        ...
        private void ClientUI_Shown(object? sender, EventArgs e)
        {
        ...
        {
            if (!_allowRealClose && WindowState == FormWindowState.Minimized)
            {
                HideToTray();
            }
        }
        ...
        private void ShowRemoteOverlay()
        {
            RunOnUi(() =>
            {
                ...
                {
                    if (!_remoteOverlay.Visible)
                        _remoteOverlay.Show();

                    _remoteOverlay.TopMost = true;
                }
            });
        }
        ...
        private void BuildConnection()
        {
            ...
            connection.On<string>("ReceiveMessage", message =>
            {
                BeginInvoke(new Action(() =>
                {
                    ...
                    ShowNotification("Új üzenet érkezett a szervertõl.", message);
                }));
            });
            ...
            connection.On<string>("ReceiveCommand", async command =>
            {
                ...
                try
                {
                    ...
                    ShowNotification("Parancs végrehajtva", command);
                }
                catch (Exception ex)
                {
                    result = "Hiba: " + ex.Message;
            ...
            connection.On("RemoteControlStarted", () =>
            {
                BeginInvoke(new Action(() =>
                {
                    AddLog("Távoli vezérlés elindult.");
                    ShowNotification("Távoli vezérlés", "Elindult");

                    ShowRemoteOverlay();
                }));
            });

            connection.On("RemoteControlStopped", () =>
            {
                BeginInvoke(new Action(() =>
                {
                    AddLog("Távoli vezérlés leállt.");
                    ShowNotification("Távoli vezérlés", "Leállt");
